...
class ContactosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contacto" do
    assert_difference('Contacto.count') do
      post contactos_url, params: { contacto: { celular: @contacto.celular, cliente_id: @contacto.cliente_id, email: @contacto.email, telefone: @contacto.telefone } }, as: :json
    end
  ...
  test "should update contacto" do
    patch contacto_url(@contacto), params: { contacto: { celular: @contacto.celular, cliente_id: @contacto.cliente_id, email: @contacto.email, telefone: @contacto.telefone } }, as: :json
    assert_response 200
  end
